...
```
A positive correlation obtained between them.
# plotting the graph for estimating calories in relation to weightkg 

```{r}
merged_2 <- merge(weight, Activity, FUN=c("Id","Date"))
head(merged_2)
ggplot(data=merged_2, aes(x=WeightKg, y=Calories)) + geom_point(color = 'red') + geom_smooth()+
  labs(title = "Relationship between WeightKg and Calories")
```
People of 80-100 weightkg are more active than other groups.
